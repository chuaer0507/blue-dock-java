...
@Component
public class MessengerExportNotifyBridge implements ExportNotifyBridge {
  private static final Logger log = LoggerFactory.getLogger(MessengerExportNotifyBridge.class);

  private final UserAccountRepository users;
  private final DialogRepository dialogs;
  private final DialogService dialogService;

  public MessengerExportNotifyBridge(
  ...
  public long sendDm(long userId, String text) {
    ...
    if (bot.isEmpty() || bot.get().getIsBot() != 1) {
      log.warn("system-msg bot missing; skip system-msg notify");
      return 0L;
    }
    ...
    try {
      ...
      log.warn("system-msg dm to {} failed: {}", userId, e.toString());
      return 0L;
    }
  }
