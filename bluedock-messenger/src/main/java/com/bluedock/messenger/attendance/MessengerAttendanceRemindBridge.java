package com.bluedock.messenger.attendance;
...
@Component
public class MessengerAttendanceRemindBridge implements AttendanceRemindBridge {
  private static final Logger log = LoggerFactory.getLogger(MessengerAttendanceRemindBridge.class);

  private final UserAccountRepository users;
  private final DialogRepository dialogs;
  private final DialogService dialogService;

  public MessengerAttendanceRemindBridge(
  ...
  public long sendDm(long userId, String text) {
    ...
    if (bot.isEmpty() || bot.get().getIsBot() != 1) {
      log.warn("attendance bot missing; skip remind");
      return 0L;
    }
    ...
    try {
      ...
      log.warn("attendance remind dm to {} failed: {}", userId, e.toString());
      return 0L;
    }
  }
